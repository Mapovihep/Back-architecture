...
namespace Services.UserService
{
    public class UserService : IUserService
    {
        ...
        private ILogger<IdentitySettings> logger;
        /*public UserService(IGetJwtSettings getJwtSettings, IUnitOfWork unitOfWork, )
        {
            _userRepository = unitOfWork.Users;
        ...
        public async Task<string> GenerateJwtToken(string password, string mail)
        {
            ...
            var securityKey = new SymmetricSecurityKey(Encoding.UTF8.GetBytes("123"));
