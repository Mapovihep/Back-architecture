...
{
    public partial class InitialWithFk : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdateBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    SetupEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UserEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RoomEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DepartmentEntityId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryLots_Setups_SetupEntityId",
                        column: x => x.SetupEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryLots_SetupEntityId",
                table: "InventoryLots",
                column: "SetupEntityId");
