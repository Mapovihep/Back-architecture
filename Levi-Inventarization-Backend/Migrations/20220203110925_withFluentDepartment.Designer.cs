...
namespace Levi_Inventarization_Backend.Migrations
{
    ...
    [Migration("20220203110925_withFluentDepartment")]
    partial class withFluentDepartment
    {
            ...
            modelBuilder.Entity("Entities.DepartmentEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("47bd47b1-681f-4b92-afbb-8787c5e76cfc"),
                            CreatedAt = new DateTime(2021, 1, 24, 17, 54, 39, 230, DateTimeKind.Local),
                            Name = "DepName",
                            UpdateBy = new Guid("56c854d1-5fe0-4c2e-8d3e-1784995bef84")
                        });
                });
            ...
            modelBuilder.Entity("Entities.RoomEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ca66e9e3-410a-4028-adf4-d063b3fbefb9"),
                            CreatedAt = new DateTime(2021, 1, 24, 17, 54, 39, 230, DateTimeKind.Local),
                            Name = "Name2"
                        });
                });
