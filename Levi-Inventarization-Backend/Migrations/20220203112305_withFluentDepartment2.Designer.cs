...
namespace Levi_Inventarization_Backend.Migrations
{
    ...
    [Migration("20220203112305_withFluentDepartment2")]
    partial class withFluentDepartment2
    {
            ...
            modelBuilder.Entity("Entities.DepartmentEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("269476c8-467b-4690-8a34-08559b1a1811"),
                            CreatedAt = new DateTime(2021, 1, 24, 17, 54, 39, 230, DateTimeKind.Local),
                            Name = "DepName",
                            UpdateBy = new Guid("09554fed-55ff-4c29-a372-41ed3d044a12")
                        });
                });
            ...
            modelBuilder.Entity("Entities.RoomEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cba49a84-33cc-433f-8186-c50b08f19913"),
                            CreatedAt = new DateTime(2021, 1, 24, 17, 54, 39, 230, DateTimeKind.Local),
                            Name = "Name2"
                        });
                });
