...
namespace Levi_Inventarization_Backend.Migrations
{
    ...
    [Migration("20220203113159_withFluentDepartment5")]
    partial class withFluentDepartment5
    {
            ...
            modelBuilder.Entity("Entities.DepartmentEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6e99923a-e4ce-487d-a981-a6ae2e6bb136"),
                            CreatedAt = new DateTime(2021, 1, 24, 17, 54, 39, 230, DateTimeKind.Local),
                            Name = "DepName",
                            UpdateBy = new Guid("20418444-0b78-4d73-9cfe-75b4aecdab93")
                        });
                });
            ...
            modelBuilder.Entity("Entities.RoomEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ff8f171f-3723-4896-a857-53a2b1273895"),
                            CreatedAt = new DateTime(2021, 1, 24, 17, 54, 39, 230, DateTimeKind.Local),
                            DepartmentEntityId = new Guid("6e99923a-e4ce-487d-a981-a6ae2e6bb136"),
                            Name = "Name2"
                        });
                });
