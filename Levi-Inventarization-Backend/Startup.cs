...
using Levi_Inventarization_Backend.ServiceConfiguration;
...
namespace Levi_Inventarization_Backend
{
    public class Startup
    {
        ...
        public void ConfigureContainer(ContainerBuilder builder)
        {
            ...
            // for you.
            builder.RegisterModule(new MyAutofacModuleService());
        }
    ...
    //public abstract class BaseAspNetCoreAutofacContainer : BaseAspNetCore
}
